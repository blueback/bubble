package com.antsoft.common.web;
...
public class Response<T> implements Serializable {
    ...
    public static <M> Response<M> getSuccessResponse(M data , String message) {
        Response<M> response = new Response<M>();
        response.setData(data);
        response.setResult(RESULT_SUCCESS);
        return response;
    ...
    public static <M> Response<M> getInputFailedResponse(String message,M data) {
        Response<M> resp = new Response<M>();
        resp.setResult(RESULT_INPUT);
        resp.setMessage(message);
        resp.setData(data);
        return resp;
    }
    ...
    public static <M> Response<M> getFailedResponse(String message,M data) {
        Response<M> resp = new Response<M>();
        resp.setResult(RESULT_FAILURE);
        resp.setMessage(message);
        resp.setData(data);
        return resp;
    }
